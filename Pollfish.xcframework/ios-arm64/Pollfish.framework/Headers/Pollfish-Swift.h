...
- (PollfishParams * _Nonnull)placementId:(NSString * _Nonnull)placementId;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nullable instancetype)initWithRewardName:(NSString * _Nonnull)rewardName rewardConversion:(double)rewardConversion OBJC_DESIGNATED_INITIALIZER;
