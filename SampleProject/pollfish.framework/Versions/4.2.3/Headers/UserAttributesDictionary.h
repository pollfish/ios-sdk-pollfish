 ...
 *
 * @param employment NSString of class EMPLOYMENT_STATUS, for example: EMPLOYMENT_STATUS(RETIRED)
 */
 ...
 *
 * @param employment NSString of class CAREER, for example: CAREER(INFORMATION_SERVICES_AND_DATA)
 */
 ...
 * Add user's income
 *
 * @param race NSString of class INCOME, for example:INCOME(MIDDLE_II)
 */
